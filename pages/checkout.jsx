...
const Checkout = () => {
  ...
  const handleSelected = (e) => {
    if(e===1){
      setAddress('By, Ikota Primary School, Rd 1, off Ikota, off Lekki - Epe Expressway, ikota, Lekki 101245, Lagos');
          ...
          <div className="md:w-1/2">
            ...
            {deliveryOption === "pickup" && (
              <>
                ...
                <p className='md:text-[15px] text-[13px]' >{address}</p>
                <div className="mt-10">
              ...
              <div className="mt-10">
                ...
                {checkout?.success && txRef && (
                  <div
                    ...
                    className="bg-secondary text-[16px] text-center w-full mt-10 py-4 text-white "
                  >
